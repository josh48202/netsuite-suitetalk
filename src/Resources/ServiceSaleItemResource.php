...
class ServiceSaleItemResource extends BaseResource
{
     ...
     * @throws GuzzleException
     */
    public function update(int $id, array $serviceSaleItem, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
