...
class NonInventoryResaleItemResource extends BaseResource
{
     ...
     * @throws GuzzleException
     */
    public function update(int $id, array $nonInventoryResaleItem, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
