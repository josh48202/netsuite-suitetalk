...
class EmployeeResource extends BaseResource
{
     ...
     * Insert record.
     *
     * @param array $employee Request body. (required)
     ...
     */
    public function create(array $employee, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('POST', 'record/v1/employee', [
    ...
    {
        try {
            $response = $this->client->request('DELETE', str_replace('{id}', $id, 'record/v1/employee/{id}'), [
                'headers' => [
    ...
    {
        try {
            $response = $this->client->request('GET', str_replace('{id}', $id, 'record/v1/employee/{id}'), [
                'query' => $this->sanitizeQueryParams([
    ...
    {
        try {
            $response = $this->client->request('GET', 'record/v1/employee', [
                'query' => $this->sanitizeQueryParams([
                    'q' => $q,
                    'limit' => $limit,
                    'offset' => $offset,
    ...
    /**
     * Operation transformExpenseReport
     *
     ...
     * @throws GuzzleException
     */
    public function transformExpenseReport(int|string $id, array $expenseReport, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('POST', str_replace('{id}', $id, 'record/v1/employee/{id}/!transform/expenseReport'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
                ]),
                'headers' => [
     ...
     * @throws GuzzleException
     */
    public function transformTimeBill(int|string $id, array $nsResource, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('POST', str_replace('{id}', $id, 'record/v1/employee/{id}/!transform/timeBill'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
                ]),
                'headers' => [
     ...
     * @throws GuzzleException
     */
    public function update(int|string $id, array $employee, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('PATCH', str_replace('{id}', $id, 'record/v1/employee/{id}'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
     ...
     * @throws GuzzleException
     */
    public function upsert(string $id, array $employee, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('PUT', str_replace('{id}', $id, 'record/v1/employee/{id}'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
                    'replaceSelectedFields' => $replaceSelectedFields,
                ]),
