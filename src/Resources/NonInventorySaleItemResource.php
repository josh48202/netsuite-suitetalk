...
class NonInventorySaleItemResource extends BaseResource
{
     ...
     * @throws GuzzleException
     */
    public function update(int $id, array $nonInventorySaleItem, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
