...
class ServicePurchaseItemResource extends BaseResource
{
    /**
     * Operation create
     *
     * Insert record.
     *
     * @param array $servicePurchaseItem Request body. (required)
     ...
     */
    public function create(array $servicePurchaseItem, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('POST', 'record/v1/servicePurchaseItem', [
    ...
    {
        try {
            $response = $this->client->request('DELETE', str_replace('{id}', $id, 'record/v1/servicePurchaseItem/{id}'), [
                'headers' => [
    ...
    {
        try {
            $response = $this->client->request('GET', str_replace('{id}', $id, 'record/v1/servicePurchaseItem/{id}'), [
                'query' => $this->sanitizeQueryParams([
    ...
    {
        try {
            $response = $this->client->request('GET', 'record/v1/servicePurchaseItem', [
                'query' => $this->sanitizeQueryParams([
                    'q' => $q,
                    'limit' => $limit,
                    'offset' => $offset,
     ...
     * @throws GuzzleException
     */
    public function update(int|string $id, array $servicePurchaseItem, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('PATCH', str_replace('{id}', $id, 'record/v1/servicePurchaseItem/{id}'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
     ...
     * @throws GuzzleException
     */
    public function upsert(string $id, array $servicePurchaseItem, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('PUT', str_replace('{id}', $id, 'record/v1/servicePurchaseItem/{id}'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
                    'replaceSelectedFields' => $replaceSelectedFields,
                ]),
