...
class InventoryAdjustmentResource extends BaseResource
{
     ...
     * Insert record.
     *
     * @param array $inventoryAdjustment Request body. (required)
     ...
     */
    public function create(array $inventoryAdjustment, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('POST', 'record/v1/inventoryAdjustment', [
    ...
    {
        try {
            $response = $this->client->request('DELETE', str_replace('{id}', $id, 'record/v1/inventoryAdjustment/{id}'), [
                'headers' => [
    ...
    {
        try {
            $response = $this->client->request('GET', str_replace('{id}', $id, 'record/v1/inventoryAdjustment/{id}'), [
                'query' => $this->sanitizeQueryParams([
    ...
    {
        try {
            $response = $this->client->request('GET', 'record/v1/inventoryAdjustment', [
                'query' => $this->sanitizeQueryParams([
                    'q' => $q,
                    'limit' => $limit,
                    'offset' => $offset,
     ...
     * @throws GuzzleException
     */
    public function update(int|string $id, array $inventoryAdjustment, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('PATCH', str_replace('{id}', $id, 'record/v1/inventoryAdjustment/{id}'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
     ...
     * @throws GuzzleException
     */
    public function upsert(string $id, array $inventoryAdjustment, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('PUT', str_replace('{id}', $id, 'record/v1/inventoryAdjustment/{id}'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
                    'replaceSelectedFields' => $replaceSelectedFields,
                ]),
