...
class NonInventoryPurchaseItemResource extends BaseResource
{
     ...
     * @throws GuzzleException
     */
    public function update(int $id, array $nonInventoryPurchaseItem, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
