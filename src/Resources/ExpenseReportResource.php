...
class ExpenseReportResource extends BaseResource
{
    /**
     * Operation create
     *
     ...
     */
    public function create(array $expenseReport, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
     ...
     * @throws GuzzleException
     */
    public function upsert(string $id, array $expenseReport, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
