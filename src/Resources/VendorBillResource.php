...
class VendorBillResource extends BaseResource
{
    /**
     * Operation create
     *
     * Insert record.
     *
     * @param array $vendorBill Request body. (required)
     ...
     */
    public function create(array $vendorBill, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('POST', 'record/v1/vendorBill', [
    ...
    {
        try {
            $response = $this->client->request('DELETE', str_replace('{id}', $id, 'record/v1/vendorBill/{id}'), [
                'headers' => [
    ...
    {
        try {
            $response = $this->client->request('GET', str_replace('{id}', $id, 'record/v1/vendorBill/{id}'), [
                'query' => $this->sanitizeQueryParams([
    ...
    {
        try {
            $response = $this->client->request('GET', 'record/v1/vendorBill', [
                'query' => $this->sanitizeQueryParams([
                    'q' => $q,
                    'limit' => $limit,
                    'offset' => $offset,
    ...
    /**
     * Operation transformVendorCredit
     *
     ...
     * @throws GuzzleException
     */
    public function transformVendorCredit(int|string $id, array $nsResource, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('POST', str_replace('{id}', $id, 'record/v1/vendorBill/{id}/!transform/vendorCredit'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
                ]),
                'headers' => [
    ...
    /**
     * Operation transformVendorPayment
     *
     ...
     * @throws GuzzleException
     */
    public function transformVendorPayment(int|string $id, array $nsResource, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('POST', str_replace('{id}', $id, 'record/v1/vendorBill/{id}/!transform/vendorPayment'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
                ]),
                'headers' => [
    ...
    /**
     * Operation transformVendorReturnAuthorization
     *
     ...
     * @throws GuzzleException
     */
    public function transformVendorReturnAuthorization(int|string $id, array $nsResource, string $replace = null, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('POST', str_replace('{id}', $id, 'record/v1/vendorBill/{id}/!transform/vendorReturnAuthorization'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
                ]),
                'headers' => [
     ...
     * @throws GuzzleException
     */
    public function update(int|string $id, array $vendorBill, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('PATCH', str_replace('{id}', $id, 'record/v1/vendorBill/{id}'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
     ...
     * @throws GuzzleException
     */
    public function upsert(string $id, array $vendorBill, string $replace = null, bool $replaceSelectedFields = false, bool $prefer = false, ?string $idempotencyKey = null, array $additionalHeaders = []): mixed
    {
        try {
            $response = $this->client->request('PUT', str_replace('{id}', $id, 'record/v1/vendorBill/{id}'), [
                'query' => $this->sanitizeQueryParams([
                    'replace' => $replace,
                    'replaceSelectedFields' => $replaceSelectedFields,
                ]),
